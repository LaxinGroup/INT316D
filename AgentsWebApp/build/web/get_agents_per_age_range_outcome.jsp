<%-- 
    Document   : get_agents_per_age_range_outcome
    Created on : 06 May 2026, 9:36:20 AM
    Author     : student
--%>
...
<html>
    <head>
        ...
        <title>Get Agents Per Age Range Outcome Page</title>
        <style>
            table,tr,td{
                padding: 8px;
    ...
    <body>
        <div>
            <h1>Get Agents Per Age Range Outcome</h1>
