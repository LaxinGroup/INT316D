<%-- 
    Document   : get_agents_per_gender_outcome
    Created on : 06 May 2026, 9:14:19 AM
    Author     : student
--%>
...
<html>
    <head>
        ...
        <title>Get Agents Per Gender Outcome Page</title>
        <style>
            table,tr,td{
                padding: 8px;
    ...
    <body>
        <div>
            <h1>Get Agents Per Gender Outcome</h1>
