<%-- 
    Document   : get_all_agents_outcome
    Created on : 06 May 2026, 8:38:37 AM
    Author     : student
--%>
...
<html>
    <head>
        ...
        <title>Get All Agents Outcome Page</title>
        <style>
            table,tr,td{
                padding: 8px;
    ...
    <body>
        <div>
            <h1>Get All Agents Outcome</h1>
            <% Integer count=(Integer)request.getAttribute("count"); %>
            <p>The total agents: <b><%=count%></b></p>
            <table border="1">
                <th>No.</th>
                <th>ID</th>
                <th>Name</th>
